...
try:
  chdir('/home/brent/src/linux-utils/crypto/certificates/mobexglobal')
  with open("subject=C_=_US_ST_=_TX_L_=_Houston_O_=_cPanel_Inc.pem", "rb") as f:
      pem_data = f.read()
  ...
  with open("subject=CN_=_mobexglobal_com.pem", "rb") as f:
      pem_data = f.read()
  # >>> with open("exercises.zip", mode="rb") as zip_file:
  # ...     contents = zip_file.read()
